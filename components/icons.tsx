...
export const PoliceIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,6.19L13.24,9.15L16.5,9.5L14.1,11.5L14.8,14.69L12,13.09L9.2,14.69L9.9,11.5L7.5,9.5L10.76,9.15L12,6.19Z" />
    </svg>
);
